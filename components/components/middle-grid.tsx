...
function normalizeIndex(middleGridIndex, innerIndex): number {
  ...
  <>
    {values.map((possibleValues, index) => (
      <div
        key={index}
        className={
          "align-center flex aspect-square w-full flex-col items-center justify-center text-center text-2xl outline outline-1 outline-offset-1"
        }
        onClick={() => {
          setSelected(index);
